...
public class MediaController extends FrameLayout {
	...
	private void initControllerView(View v) {
		...
		mVolumeBar = (ProgressBar) v
				.findViewById(R.id.mediacontroller_volume_seekbar);
		mVolumeButton = (ImageButton) v
				.findViewById(R.id.mediacontroller_volume);
		...
		if (mVolumeButton != null) {
			mVolumeButton.setOnClickListener(new View.OnClickListener() {
				...
				public void onClick(View v) {
					...
					mVolumeButton.setSelected(!mVolumeButton.isSelected());

					show(mVolumeButton.isSelected() ? 3600000 : sDefaultTimeout);

					if (mVolumeBar != null)
						mVolumeBar.setVisibility(mVolumeButton.isSelected() ? View.VISIBLE
								: View.GONE);
				...
				volumeAdjuster
						.setOnSeekBarChangeListener(new SeekBar.OnSeekBarChangeListener() {
							...
							public void onProgressChanged(SeekBar seekBar,
								...
								int current = progress * mMaxVolume / 100;
	...
	public void hide() {
		...
		if (mShowing) {
			...
			mVolumeButton.setSelected(false);
